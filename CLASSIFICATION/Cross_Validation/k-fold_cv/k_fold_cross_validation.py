...
dataset = pd.read_csv(r"D:\NIT\1. NIT_Batches\2. EVENING BATCH\N_Batch -- 7.00PM -- Aug 26\4. May\15th - Cross validation\1.K-FOLD CROSS VALIDATION CODE_ MODEL SELECTION\Social_Network_Ads.csv")
